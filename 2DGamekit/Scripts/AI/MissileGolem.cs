...
#endif
{
    ...
    void OnEnable()
    {
        if (JoLeClodo.PlayerInstance != null)
        {
            JoLeClodo.PlayerInstance.damageable.OnDie.AddListener(PlayerDied);
        }
    ...
    private void OnDisable()
    {
        if (JoLeClodo.PlayerInstance != null)
        {
            JoLeClodo.PlayerInstance.damageable.OnDie.RemoveListener(PlayerDied);
        }
    }

...
namespace Gamekit2D
{
    ...
    public class JoLeClodo : MonoBehaviour
    {
        static protected JoLeClodo s_PlayerInstance;
        static public JoLeClodo PlayerInstance { get { return s_PlayerInstance; } }
        ...
        void Start()
        {
            ...
            SceneLinkedSMB<JoLeClodo>.Initialise(m_Animator, this);
